...
public class frame extends javax.swing.JFrame {
   ...
   String Ans = "tami@gmail.com";
    String Psw = "secretcode";
    /**
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(160, 160, 215));
        ...
        jButton1.setBackground(new java.awt.Color(222, 240, 236));
        ...
        jLabel5.setForeground(new java.awt.Color(101, 169, 255));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String EmAdd = jTextField1.getText();
        if (EmAdd.equals (Ans))
    {
        String EmSub = jTextField2.getText();
        if (EmSub.equals (Psw))
